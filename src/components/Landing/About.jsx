...
export const About = () => {
  return (
    <MainLayout>
      ...
      <section
        className="grid grid-cols-1 place-items-center gap-5 md:grid-cols-2 pt-20 md:pt-0"
        id="about"
      >
        <div className="plant-img relative">
          <img
            ...
            alt=""
          />
          <div className="ring-[15px] ring-white/80 ring-inset bg-gradient-to-t from-purple to-primary opacity-90 absolute -inset-x-10 md:-inset-x-20 inset-y-4 w-72 h-full md:w-96 rounded-t-full  -z-10"></div>

          <div className="animate-pulse bg-fuchsia-400 blur-3xl opacity-90 absolute -inset-x-10 md:-inset-x-20 inset-y-4 w-56 h-56 md:w-64 md:h-64 rounded-full -z-20"></div>
          <div className="animate-pulse bg-sky-400 blur-3xl opacity-90 absolute -inset-x-10 md:inset-x-20 inset-y-48 w-56 h-56 md:w-64 md:h-64 rounded-full -z-20"></div>
        </div>
